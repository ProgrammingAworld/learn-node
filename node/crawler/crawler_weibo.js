...
var getFollowPersonByPageUrl = function(followUrl, cb) {
  request({
    ...
    $("table tr").each(function(index, el) {
      followArray.push({followName: this.children[1].children[0].children[0].data, followId: this.children[0].children[0].attribs.href, followPhoto: this.children[0].children[0].children[0].attribs.src});
    });
    cb(null);
  });
}
